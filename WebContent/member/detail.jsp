					...
					<div class="join-container">
						...
						<form action="/admin/member/add" name="member" method="post">
							<div class="form-group">
								<div class="input-box">
									<label>아이디</label> 
									<input type="text" name="loginId" placeholder="아이디" required readonly> 
								</div>
								<div class="input-box">
									<label>비밀번호</label>
							...
							<div class="form-group">
								...
								<div class="input-box">
									...
									<div class="email-box">
										...
										<input type="text" name="customAddress" class="customAddress"
											placeholder="naver.com" disabled="true">
									</div>
								</div>
							</div>
							...
							<div class="button-area">
								<input type="submit" value="저장" class="puple-button-wf submit-button">
							</div>
