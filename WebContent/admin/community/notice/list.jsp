							...
							<form action="list" method="post">
								<div class="notice-select">
									<input class="select-checkbox" type="checkbox"
										...
										type="checkbox" name="checkCategory" value='민슈찍'>민슈찍 <input
										class="select-checkbox" type="checkbox" name="checkCategory"
										value='민슈부'>민슈부 <input class="select-checkbox"
										type="checkbox" name="checkCategory" value='반민슈찍'>반민슈찍
									<input class="select-checkbox" type="checkbox"
										name="checkCategory" value='반민슈부'>반민슈부 <input
										class="select-checkbox" type="checkbox" name="checkCategory"
										value='민팥찍'>민팥찍 <input class="select-checkbox"
										type="checkbox" name="checkCategory" value='민팥부'>민팥부 <input
										class="select-checkbox" type="checkbox" name="checkCategory"
										value='반민팥찍'>반민팥찍 <input class="select-checkbox"
										type="checkbox" name="checkCategory" value='반민팥부'>반민팥부
									<input type="submit" value="검색"
										class="gray-button-s category-search">
